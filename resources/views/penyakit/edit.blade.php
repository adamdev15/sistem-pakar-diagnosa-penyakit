<x-app-layout>
    @section('header', 'Edit Penyakit')

    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden max-w-4xl">
        <div class="p-6 border-b border-gray-100">
            <h3 class="text-lg font-semibold text-gray-800">Form Edit Penyakit: {{ $penyakit->kode_penyakit }}</h3>
        </div>
        
        <form action="{{ route('penyakit.update', $penyakit->id) }}" method="POST" class="p-6 space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="kode_penyakit" id="kode_penyakit" value="{{ old('kode_penyakit', $penyakit->kode_penyakit) }}" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm" required>
                ...
                <div>
                    ...
                    <input type="text" name="nama_penyakit" id="nama_penyakit" value="{{ old('nama_penyakit', $penyakit->nama_penyakit) }}" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm" required>
            ...
            <div>
                ...
                <textarea name="deskripsi" id="deskripsi" rows="3" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm">{{ old('deskripsi', $penyakit->deskripsi) }}</textarea>
            ...
            <div>
                ...
                <textarea name="penyebab" id="penyebab" rows="3" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm">{{ old('penyebab', $penyakit->penyebab) }}</textarea>
            ...
            <div>
                ...
                <textarea name="solusi" id="solusi" rows="3" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm">{{ old('solusi', $penyakit->solusi) }}</textarea>
            ...
            <div>
                ...
                <textarea name="pencegahan" id="pencegahan" rows="3" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm">{{ old('pencegahan', $penyakit->pencegahan) }}</textarea>
            ...
            <div>
                ...
                <select name="status" id="status" class="w-full rounded-lg border-gray-300 focus:border-green-500 focus:ring-green-500 shadow-sm" required>
                    <option value="aktif" {{ old('status', $penyakit->status) === 'aktif' ? 'selected' : '' }}>Aktif</option>
                    <option value="nonaktif" {{ old('status', $penyakit->status) === 'nonaktif' ? 'selected' : '' }}>Nonaktif</option>
                </select>
